...
import argparse
from transformers import BertTokenizer, XLMTokenizer, XLMRobertaTokenizer, CamembertTokenizer
import os
...
def panx_tokenize_preprocess(args):
    ...
    for lang in args.languages.split(','):
        ...
        if args.model_name_or_path == "airesearch/wangchanberta-base-att-spm-uncased":
            # wangchanberta only support Thai
            if lang != 'th':
                print(f"Skip {lang} for {args.model_name_or_path}")
                continue
