...
echo "Preprocess $TASK dataset"
echo "python3 $REPO/utils_preprocess.py \
  ...
  --max_len $MAXL \
  --output_dir $SAVE_DIR \
  --languages $LANGS $SCRIPT_ARGS >> $SAVE_DIR/preprocess.log"
